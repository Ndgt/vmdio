...
namespace vmdio::encoding
{
     ...
     *         during conversion to Shift_JIS, or if the input string is too large to process.
     */
     ...
     * @throws vmdio::exceptions::StringProcessError if Windows API functions show some error
     *         during conversion to UTF-8, or if the input string is too large to process.
     */
